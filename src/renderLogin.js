...
export function renderSigninForm({
    ...
    ${
        isLoginMode
            ? ""
            : `<input type="text" id="signin-name-input" class="add-form-name" placeholder="Введите имя" value="" />
          <br><br>`
    }
          ...
          <div class="add-form-row">
            <button id="signin-button" class="add-form-button">${
                isLoginMode ? `Войти` : `Зарегистрироваться`
            }</button>
          </div>
          <div class="add-form-row">
          <button id="toggle-button" class="add-form-button">Перейти ${
        ...
        document
            ...
            .addEventListener("click", () => {
                if (isLoginMode) {
                    const login =
                        document.getElementById("signin-login-input").value;
                    ...
                    const name =
                        document.getElementById("signin-name-input").value;
