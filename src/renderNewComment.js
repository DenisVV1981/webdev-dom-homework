...
export function renderNewCommentForm({
    ...
    <div id="comment-form" class="add-form">
      <input type="text" id="name-input" disabled class="add-form-name" placeholder="Введите ваше имя" value="${window.localStorage.getItem(
          "userName",
      )}" />
